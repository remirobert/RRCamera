#
#  Be sure to run `pod spec lint RRCamera.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors            = { "remirobert" => "remi.robert@epitech.eu" }
  ...
  s.source       = { :git => "https://github.com/remirobert/RRCamera.git", :tag => "0.1.0" }
